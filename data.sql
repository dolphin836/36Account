CREATE TABLE `member` (
    ...
    `client` TINYINT(2) UNSIGNED NOT NULL DEFAULT 0 COMMENT '用户注册客户端：0 - 未知、1 - 系统创建、2 - PC web、3 - 移动 web、4 - iOS、5 - Android、6 - 微信小程序',
    `application` TINYINT(2) UNSIGNED NOT NULL DEFAULT 0 COMMENT '用户注册应用：0 - 未知、1 - 36photo.cn、2 - 36password.com、3 - 36awesome.com',
